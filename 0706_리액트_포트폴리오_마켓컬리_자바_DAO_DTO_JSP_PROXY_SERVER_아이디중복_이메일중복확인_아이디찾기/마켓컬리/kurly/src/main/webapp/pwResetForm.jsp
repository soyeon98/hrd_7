...
<div id='login'>
	<div class='container'>
		...
		<div class="content">
		    <form name="pwSearchForm" autocomplete="off" id="pwSearchForm" method="post" action="./pwResetAction.jsp">
		        <ul>
		            <li><input  maxlength="30" type="text" name="user_id" id="user_id" placeholder="아이디를 입력하세요"></li>
		            <li><input maxlength="250" type="text" name="user_pw" id="user_pw" placeholder="비밀번호를 입력하세요"></li>
		        </ul>
