...
<%
	...
	if( request.getParameter("user_pw")==null || request.getParameter("user_pw")==null || request.getParameter("user_pw2")==null ||request.getParameter("user_pw")!=request.getParameter("user_pw2")){
		%> 
			<script>
