...
CREATE TABLE `signup_table` (
  ...
  `user_ph` varchar(13) COLLATE utf8mb4_general_ci NOT NULL COMMENT '휴대폰',
...
INSERT INTO signup_table (user_id, user_pw, user_name, user_email,user_ph, user_address, user_gender, user_birth, user_chooga, user_service) VALUES
('aaaaaa', 'aaaaaa', '박소연', 'aaa@naver.com', '010-2701-8808', '파주', '여성', '980317', '마켓컬리 일일세일', '이용약관 동의필수');
